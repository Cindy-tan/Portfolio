...
const sections = [
  { text: "Creative Designer", backgroundColorcolor: "#FF5733" },
  { text: "Social Media Manager", color: "#33FF57" },
...
export default function LandingPage() {
  ...
  return (
    <motion.div
      className="h-screen w-full flex justify-center items-center text-white text-4xl font-bold"
