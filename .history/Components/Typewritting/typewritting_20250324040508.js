...
export default function LandingPage() {
  ...
  useEffect(() => {
    let i = 0;
    setDisplayText(""); // Clears text each time scroll happens
  ...
  return (
    <motion.div
      className="h-screen w-full flex justify-center items-center text-white text-5xl font-bold text-center px-4"
