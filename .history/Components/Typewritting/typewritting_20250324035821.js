...
const sections = [
    ...
    { text: "As designers, we are like Curious George—constantly exploring new challenges and learning from our mistakes. We might fall into the cats trap, but we’re never stuck. 
