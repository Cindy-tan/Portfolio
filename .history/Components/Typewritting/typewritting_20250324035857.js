...
const sections = [
    ...
    { text: "As designers, we are like Curious George—constantly exploring new challenges and learning from our mistakes. 
    We might fall into the cats trap, but we are never stuck. There's always someone cheering us on, reminding us to trust ourselves, stay confident, and trust the process.", color: "#3357FF" },
